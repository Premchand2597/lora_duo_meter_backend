...
import com.loraDuoMeter.Service.Device_Event_Notification_Service;
import com.loraDuoMeter.Service.Recharge_Finish_Service;

@RestController
@RequestMapping("/api")
public class Manual_Device_Notification_Controller {
	

	 @Autowired
	    private Device_Event_Notification_Service service;	
	 
	 @Autowired
	 private IDevice_Event_Notification_Repo repo;

	    
	 @GetMapping("/device_notification")
	 public List<ManualDeviceNotificationDisplay_DTO> fetchLatestByDevEui() {
	     return service.getLatestByDevEui();
	 }
	 	
	 @GetMapping("/device_notification_devEui/{devEui}")
