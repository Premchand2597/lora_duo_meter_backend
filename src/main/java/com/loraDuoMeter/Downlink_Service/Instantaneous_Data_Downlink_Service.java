...
@Service
public class Instantaneous_Data_Downlink_Service {
	
	
	 private final JdbcTemplate jdbcTemplate;
	    
	    public Instantaneous_Data_Downlink_Service(JdbcTemplate jdbcTemplate) {
	        this.jdbcTemplate = jdbcTemplate;
	    }

	    private static final String INSERT_SQL =
	        "INSERT INTO odm_instantaneous_data_read_table (" +
	    ...
	    public void save(Instantaneous_Data_Downlink_Dto packet,
	    ...
	    private Object[] toSqlArgs(Instantaneous_Data_Downlink_Dto packet, MQTT_Listner_Receive_Data_Dto uplink) {
