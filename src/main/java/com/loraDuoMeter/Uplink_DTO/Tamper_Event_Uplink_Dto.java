...
public class Tamper_Event_Uplink_Dto {
	...
	public Tamper_Event_Uplink_Dto(String sl_no, String command_id, String reserved_byte, String network_type,
	...
	public Tamper_Event_Uplink_Dto() {
		super();
