...
@Entity
@Table(name = "power_up_table")
public class Power_Up_Uplink_Entity {
	...
	public Power_Up_Uplink_Entity(String sl_no, String command_id, String reserved_byte, String network_type,
	...
	public String toString() {
		return "Power_Up_Uplink_Entity [sl_no=" + sl_no + ", command_id=" + command_id + ", reserved_byte="
