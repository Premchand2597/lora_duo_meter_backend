...
@Entity
@Table(name="gas_leak_table")
public class Gas_Leak_Uplink_Entity {
	...
	public Gas_Leak_Uplink_Entity(String sl_no, String command_id, String reserved_byte, String network_type,
			...
			String flow_type, String last_update_time, String device_id, String application_id, String dev_eui,
	...
	public String toString() {
		return "Gas_Leak_Uplink_Entity [sl_no=" + sl_no + ", command_id=" + command_id + ", reserved_byte="
				...
				+ ", battery_voltage=" + battery_voltage + ", next_update_time=" + next_update_time + ", flow_type="
				+ flow_type + ", last_update_time=" + last_update_time + ", device_id=" + device_id
