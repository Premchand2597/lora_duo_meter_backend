...
public class Device_Event_Notification_Uplink_Entity {
	...
	public Device_Event_Notification_Uplink_Entity(String sl_no, String command_id, String reserved_byte,
			String network_type, String device_type, String meter_model, String firmware_version,
			String meter_connection_type, String valve_status, String device_rtc, String pulse_count,
			String battery_voltage, String next_update_time, String pending_event, String recharge_status,
			String last_update_time, String device_id, String application_id, String dev_eui, String join_eui,
			String device_address, String received_at, String f_port, String f_cnt, String payload, String port,
			String gateway_id, String gateway_eui, String rssi, String channel_rssi, String snr, String bandwidth,
			String spreading_factor, String frequency, String net_id) {
		super();
		this.sl_no = sl_no;
		this.command_id = command_id;
		this.reserved_byte = reserved_byte;
	...
	public Device_Event_Notification_Uplink_Entity() {
		super();
	...
	public String toString() {
		return "Device_Event_Notification_Uplink_Entity [sl_no=" + sl_no + ", command_id=" + command_id
				+ ", reserved_byte=" + reserved_byte + ", network_type=" + network_type + ", device_type=" + device_type
				+ ", meter_model=" + meter_model + ", firmware_version=" + firmware_version + ", meter_connection_type="
