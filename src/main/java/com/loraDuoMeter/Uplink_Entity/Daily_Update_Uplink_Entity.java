...
public class Daily_Update_Uplink_Entity {
	...
	public String toString() {
		return "Daily_Update_Uplink_Entity [sl_no=" + sl_no + ", command_id=" + command_id + ", reserved_byte="
	...
	public Daily_Update_Uplink_Entity(String sl_no, String command_id, String reserved_byte, String network_type,
	...
	public Daily_Update_Uplink_Entity() {
		super();
