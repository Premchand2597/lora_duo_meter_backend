...
public class Battery_Cut_Off_Uplink_Entity {
	...
	public Battery_Cut_Off_Uplink_Entity(String sl_no, String command_id, String reserved_byte, String network_type,
			String device_type, String firmware_version, String meter_connection_type, String valve_status,
	...
	public String toString() {
		return "Battery_Cut_Off_Uplink_Entity [sl_no=" + sl_no + ", command_id=" + command_id + ", reserved_byte="
				+ reserved_byte + ", network_type=" + network_type + ", device_type=" + device_type
				+ ", firmware_version=" + firmware_version + ", meter_connection_type=" + meter_connection_type
				+ ", valve_status=" + valve_status + ", device_rtc=" + device_rtc + ", pulse_count=" + pulse_count
				+ ", battery_voltage=" + battery_voltage + ", next_update_time=" + next_update_time
	...
	public Battery_Cut_Off_Uplink_Entity() {
		super();
