package com.loraDuoMeter.Uplink_Entity;
...
@Entity
@Table(name = "tamper_event_table")
public class Tamper_Event_Uplink_Entity {
	...
	public Tamper_Event_Uplink_Entity(String sl_no, String command_id, String reserved_byte, String network_type,
			...
			String tamper_type, String last_update_time, String device_id, String application_id, String dev_eui,
			String join_eui, String device_address, String received_at, String f_port, String f_cnt, String payload,
			String port, String gateway_id, String gateway_eui, String rssi, String channel_rssi, String snr,
			String bandwidth, String spreading_factor, String frequency, String net_id) {
		super();
		this.sl_no = sl_no;
		this.command_id = command_id;
		this.reserved_byte = reserved_byte;
	...
	public String toString() {
		return "Tamper_Event_Uplink_Entity [sl_no=" + sl_no + ", command_id=" + command_id + ", reserved_byte="
				+ reserved_byte + ", network_type=" + network_type + ", device_type=" + device_type + ", meter_model="
				+ meter_model + ", firmware_version=" + firmware_version + ", meter_connection_type=" + meter_connection_type
				+ ", valve_status=" + valve_status + ", device_rtc=" + device_rtc + ", pulse_count=" + pulse_count
				+ ", battery_voltage=" + battery_voltage + ", next_update_time=" + next_update_time + ", tamper_type="
				+ tamper_type + ", last_update_time=" + last_update_time + ", device_id=" + device_id
				+ ", application_id=" + application_id + ", dev_eui=" + dev_eui + ", join_eui=" + join_eui
				+ ", device_address=" + device_address + ", received_at=" + received_at + ", f_port=" + f_port
				+ ", f_cnt=" + f_cnt + ", payload=" + payload + ", port=" + port + ", gateway_id=" + gateway_id
				+ ", gateway_eui=" + gateway_eui + ", rssi=" + rssi + ", channel_rssi=" + channel_rssi + ", snr=" + snr
				+ ", bandwidth=" + bandwidth + ", spreading_factor=" + spreading_factor + ", frequency=" + frequency
				+ ", net_id=" + net_id + "]";
	}

	public Tamper_Event_Uplink_Entity() {
		super();
