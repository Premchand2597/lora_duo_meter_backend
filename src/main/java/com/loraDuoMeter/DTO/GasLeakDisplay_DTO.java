...
public class GasLeakDisplay_DTO {
	...
	public GasLeakDisplay_DTO(Long slNo, String networkType, String deviceType, String meterConnection,
			String meterModel, String valveStatus, String deviceRtc, String pulseCount, String batteryVoltage,
			String nextUpdateTime, String flowType, String lastUpdateTime, String devEui, String gatewayEui,
			Integer fPort, String receivedAt, String buildingName, String residentName) {
		super();
		this.slNo = slNo;
		this.networkType = networkType;
		this.deviceType = deviceType;
