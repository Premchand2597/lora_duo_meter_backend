...
@Entity
@Table(name = "battery_cut_off_table")
public class Battery_Cut_Off_Entity {
	...
	public Battery_Cut_Off_Entity(Long sl_no, String command_id, String reserved_byte, String network_type,
	...
	public String toString() {
		return "Battery_Cut_Off_Entity [sl_no=" + sl_no + ", command_id=" + command_id + ", reserved_byte="
