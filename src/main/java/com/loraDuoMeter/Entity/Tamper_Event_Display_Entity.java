...
public class Tamper_Event_Display_Entity {	
	...
	public Tamper_Event_Display_Entity(Long sl_no, String command_id, String reserved_byte, String network_type,
	...
	public Tamper_Event_Display_Entity() {
		super();
	...
	public String toString() {
		return "Tamper_Event_Display [sl_no=" + sl_no + ", command_id=" + command_id + ", reserved_byte="
				...
				+ next_update_time + ", tamper_type=" + tamper_type + ", last_update_time=" + last_update_time
				+ ", device_id=" + device_id + ", application_id=" + application_id + ", dev_eui=" + dev_eui
				+ ", join_eui=" + join_eui + ", device_address=" + device_address + ", received_at=" + received_at
				+ ", f_port=" + f_port + ", f_cnt=" + f_cnt + ", payload=" + payload + ", port=" + port
				+ ", gateway_id=" + gateway_id + ", gateway_eui=" + gateway_eui + ", rssi=" + rssi + ", channel_rssi="
				+ channel_rssi + ", snr=" + snr + ", bandwidth=" + bandwidth + ", spreading_factor=" + spreading_factor
				+ ", frequency=" + frequency + ", net_id=" + net_id + "]";
	}
