...
public class Power_Up_Display_Entity {
	...
	public Power_Up_Display_Entity(Long sl_no, String command_id, String reserved_byte, String network_type,
	...
	public Power_Up_Display_Entity() {
		super();
	...
	public String toString() {
		return "Power_Up_Display_Entity [sl_no=" + sl_no + ", command_id=" + command_id + ", reserved_byte="
