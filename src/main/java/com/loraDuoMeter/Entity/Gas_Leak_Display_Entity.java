...
public class Gas_Leak_Display_Entity {
	...
	public Gas_Leak_Display_Entity(Long sl_no, String command_id, String reserved_byte, String network_type,
	...
	public Gas_Leak_Display_Entity() {
		super();
	...
	public String toString() {
		return "Gas_Leak_Display_Entity [sl_no=" + sl_no + ", command_id=" + command_id + ", reserved_byte="
				...
				+ next_update_time + ", flow_type=" + flow_type + ", last_update_time=" + last_update_time
