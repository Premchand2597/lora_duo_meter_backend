...
public class BatteryCutOff_Entity {
	...
	public String toString() {
		return "BatteryCutOff_Entity [slNo=" + slNo + ", reservedType=" + reservedType + ", networkType=" + networkType
				+ ", deviceType=" + deviceType + ", firmwareVersion=" + firmwareVersion + ", meterConnectionType="
				+ meterConnectionType + ", valveStatus=" + valveStatus + ", deviceRtc=" + deviceRtc + ", pulseCount="
				+ pulseCount + ", batteryVoltage=" + batteryVoltage + ", nextUpdateTime=" + nextUpdateTime
				+ ", lastUpdateTime=" + lastUpdateTime + ", deviceId=" + deviceId + ", applicationId=" + applicationId
				+ ", devEui=" + devEui + ", joinEui=" + joinEui + ", deviceAddress=" + deviceAddress + ", receivedAt="
				+ receivedAt + ", fPort=" + fPort + ", fCnt=" + fCnt + ", payload=" + payload + ", port=" + port
				+ ", gatewayId=" + gatewayId + ", gatewayEui=" + gatewayEui + ", rssi=" + rssi + ", channelRssi="
				+ channelRssi + ", snr=" + snr + ", bandwidth=" + bandwidth + ", spreadingFactor=" + spreadingFactor
				+ ", frequency=" + frequency + ", netId=" + netId + "]";
	}
