...
@Entity
@Table(name = "recharge_finish_table")
public class Recharge_Finish_Display_Entity {
	...
	public Recharge_Finish_Display_Entity(Long sl_no, String command_id, String reserved_byte, String network_type,
	...
	public Recharge_Finish_Display_Entity() {
		super();
	...
	public String toString() {
		return "Recharge_Finish_Display [sl_no=" + sl_no + ", command_id=" + command_id + ", reserved_byte="
				...
				+ next_update_time + ", last_update_time=" + last_update_time + ", device_id=" + device_id
