...
public class RechargeFinish_Entity {
	...
	public String toString() {
		return "RechargeFinish_Entity [slNo=" + slNo + ", reservedByte=" + reservedByte + ", networkType=" + networkType
				+ ", deviceType=" + deviceType + ", meterModel=" + meterModel + ", firmwareVersion=" + firmwareVersion
				+ ", meterConnectionType=" + meterConnectionType + ", valveStatus=" + valveStatus + ", deviceRtc="
				+ deviceRtc + ", pulseCount=" + pulseCount + ", batteryVoltage=" + batteryVoltage + ", nextUpdateTime="
				+ nextUpdateTime + ", lastUpdateTime=" + lastUpdateTime + ", deviceId=" + deviceId + ", applicationId="
				...
				+ spreadingFactor + ", frequency=" + frequency + ", netId=" + netId + ", commandId=" + commandId + "]";
	}
}
