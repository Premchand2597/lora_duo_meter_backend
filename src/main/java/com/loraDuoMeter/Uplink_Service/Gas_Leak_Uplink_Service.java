...
@Service
public class Gas_Leak_Uplink_Service {
	
	 private final JdbcTemplate jdbcTemplate;
	    
	    public Gas_Leak_Uplink_Service(JdbcTemplate jdbcTemplate) {
	        this.jdbcTemplate = jdbcTemplate;
	    }

	    private static final String INSERT_SQL =
	        "INSERT INTO gas_leak_table (" +
	    ...
	    public void save(Gas_Leak_Uplink_Dto packet,
	    ...
	    private Object[] toSqlArgs(Gas_Leak_Uplink_Dto packet,
	                              MQTT_Listner_Receive_Data_Dto uplink) {
	        ...
	        return new Object[]{
	            ...
	            packet.getNext_update_time(),packet.getFlow_type(),
