...
import com.loraDuoMeter.Uplink_DTO.Battery_Cut_Off_Uplink_Dto;

import jakarta.annotation.PostConstruct;

@Service
public class Battery_Cut_Off_Uplink_Service {
	
	 private final JdbcTemplate jdbcTemplate;
	    
	    public Battery_Cut_Off_Uplink_Service(JdbcTemplate jdbcTemplate) {
	        this.jdbcTemplate = jdbcTemplate;
	    }

	    private static final String INSERT_SQL =
	        "INSERT INTO battery_cut_off_table (" +
	        "command_id, reserved_byte, network_type, device_type, firmware_version, " +
	    ...
	    public void save(Battery_Cut_Off_Uplink_Dto packet,
	    ...
	    private Object[] toSqlArgs(Battery_Cut_Off_Uplink_Dto packet,
	                              MQTT_Listner_Receive_Data_Dto uplink) {

	        return new Object[]{
	            packet.getCommand_id(), packet.getReserved_byte(), packet.getNetwork_type(),
	            packet.getDevice_type(), packet.getFirmware_version(), packet.getMeter_connection_type(),
	            packet.getValve_status(), packet.getDevice_rtc(),
