...
@Service
public class Tamper_Event_Uplink_Service {
	
	 private final JdbcTemplate jdbcTemplate;
	    
	    public Tamper_Event_Uplink_Service(JdbcTemplate jdbcTemplate) {
	        this.jdbcTemplate = jdbcTemplate;
	    }

	    private static final String INSERT_SQL =
	        "INSERT INTO tamper_event_table (" +
	    ...
	    public void save(Tamper_Event_Uplink_Dto packet,
	    ...
	    private Object[] toSqlArgs(Tamper_Event_Uplink_Dto packet,
	                              MQTT_Listner_Receive_Data_Dto uplink) {
	        ...
	        return new Object[]{
	            ...
	            packet.getNext_update_time(), packet.getTamper_type(),
