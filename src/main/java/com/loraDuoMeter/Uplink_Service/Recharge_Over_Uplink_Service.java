...
@Service
public class Recharge_Over_Uplink_Service {
	
	private final JdbcTemplate jdbcTemplate;
    
    public Recharge_Over_Uplink_Service(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    private static final String INSERT_SQL =
        "INSERT INTO recharge_finish_table (" +
    ...
    public void save(Recharge_Over_Uplink_Dto packet,
    ...
    private Object[] toSqlArgs(Recharge_Over_Uplink_Dto packet,
                              MQTT_Listner_Receive_Data_Dto uplink) {
