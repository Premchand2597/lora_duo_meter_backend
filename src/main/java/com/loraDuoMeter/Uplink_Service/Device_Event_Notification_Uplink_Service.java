...
@Service
public class Device_Event_Notification_Uplink_Service {
	
	 private final JdbcTemplate jdbcTemplate;
	    
	    public Device_Event_Notification_Uplink_Service(JdbcTemplate jdbcTemplate) {
	        this.jdbcTemplate = jdbcTemplate;
	    }

	    private static final String INSERT_SQL =
	        "INSERT INTO device_event_notification_table (" +
	    ...
	    public void save(Device_Event_Notification_Uplink_Dto packet,
	    ...
	    private Object[] toSqlArgs(Device_Event_Notification_Uplink_Dto packet,
	                              MQTT_Listner_Receive_Data_Dto uplink) {
	        ...
	        return new Object[]{
	            ...
	            packet.getNext_update_time(),packet.getPending_event(), packet.getRecharge_status(),
